...
More [[Baselines vs Benchmarks|benchmarks]]: molecular property prediction (Ngyugen et al. ’20), object pose prediction (Yin et al. ICLR ’20), channel coding (Li et al. ’21)
...
- - -
![[Optimization-based Adaptation.png|500]]
...
MAML是[[Meta Learning#3.3.1 Concepts|Concept训练流程]]的一个特例，也就是$N=1$，因此需要计算二阶导数才能反向传播。
...
![[Pre-train vs MAML vs Reptile.png]]
...
##### iMAML
[iMAML: Meta-Learning with Implicit Gradients (Paper Explained)](https://www.youtube.com/watch?v=u5BkO8XMS2I)
...
![[MAML v.s. Pre-training 2.png|400]]

通常Pre-training训练流程如下：
![[Pre-training.png|500]]
...
![[MAML v.s. Pre-training 1.png|400]]
