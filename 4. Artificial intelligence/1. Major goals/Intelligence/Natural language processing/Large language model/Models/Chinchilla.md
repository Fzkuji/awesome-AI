...
![[Resources/4. Artificial intelligence/1. Major goals/Intelligence/Natural language processing/Large language model/Figure 3.png]]
...
$$
文章使用了[[Loss function#Huber loss|Huber loss]]
...
$$
We show contours of the fitted function $\hat{L}$ in [[Chinchilla#^910ca9|Figure 4 (left)]], and the closed-form efficient computational frontier in blue. From this approach, we find that $a=0.46$ and $b=0.54$-as summarized in Table 2 .
