这是一份专注于使用人工智能方法解决推荐系统问题的笔记。以下是笔记的主要内容：

1. **主题介绍**：笔记涵盖了多个子方向，包括：
   - 大型语言模型用于推荐系统（[LLM4Rec](LLM4Rec.md)）
   - 强化学习用于推荐系统（[RL4Rec](RL4Rec.md)）
   - 多任务学习用于推荐系统（[MTL4Rec](MTL4Rec.md)）

2. **论文解读**：详细解读了一篇论文，该论文探讨了如何通过理解用户在搜索和推荐行为中的相似和不相似的兴趣，帮助模型更好地理解用户的需求和偏好。

3. **数据集介绍**：列出了一系列用于点击率预测任务的数据集，包括：
   - Criteo广告数据集
   - MovieLens电影推荐数据集
   - 亚马逊评论数据集
   - 阿里巴巴国际广告算法竞赛数据集
...
这份笔记是一个全面的、深入的关于使用人工智能方法解决推荐系统问题的学习资源，无论是对推荐系统有深入研究的专业人士，还是对推荐系统感兴趣的初学者，都可以从中获得宝贵的知识和启示。
...
![350](../../../Attachments/4.%20Artificial%20intelligence/3.%20Applications/Recommender%20system/AI4Rec/IMG-20240214165835747.jpg)
...
这个是*KDD Cup 2023 Workshop: Multilingual Session Recommendation Challenge*的数据集
...
2. 新任务：论文提出了使用该数据集评估推荐和文本生成算法的3个新任务：
	- Sequential recommendation：预测用户会话中的下一个产品。
	- Sequential recommendation with domain shifts：在大地区的数据上进行预训练，然后在小地区上进行微调，以克服数据稀缺的问题。
	- Content generation/Next item title generation：预测在训练期间未见过的下一个产品的标题。
...
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| [MMoE](../../1.%20Major%20goals/Cognition/Machine%20learning/General%20Multi-Task%20Learning/Special%20Multi-Task%20Learning/+Papers/MMoE.md) | [Modeling Task Relationships in Multi-task Learning with Multi-gate Mixture-of-Experts](#Modeling%20Task%20Relationships%20in%20Multi-task%20Learning%20with%20Multi-gate%20Mixture-of-Experts) | KDD 2018    | [DeepCTR-Torch](https://github.com/shenweichen/DeepCTR-Torch) | [doi.org/10.1145/3219819.3220007](https://doi.org/10.1145/3219819.3220007) | [Multi-scenario learning](#Multi-scenario%20learning), Multi-task learning |

![Pasted image 20230713091222](../../../Attachments/4.%20Artificial%20intelligence/1.%20Major%20goals/Cognition/Machine%20learning/General%20Multi-Task%20Learning/Special%20Multi-Task%20Learning/+Papers/MMoE/IMG-20250415145140278.png)
