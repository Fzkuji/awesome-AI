...
DSI是一个端到端模型，并且证明比[[Dual encoder]]要好，在zero-shot设置中也优于[[Okapi BM25]]。
...
![[Hierarchical clustering  process.png|600]]
...
2. [[DSI#^576d1d|automatically learn semantic identifiers in a fully end-to-end manner]]
3. [[DSI#^7ef472|非典型多任务学习]]
