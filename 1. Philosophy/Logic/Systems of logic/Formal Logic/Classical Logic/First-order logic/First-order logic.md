...
- Augments the logical connectives from propositional logic with
	- [[Predicate|predicates]] that describe properties of objects,
	- [[Function#^162e9c|functions]] that map objects to one another, and
	- [[Quantifier|quantifers]] that allow us to reason about multiple objects.
...
[[The art of translation.pdf|The art of translation]]介绍了翻译一阶逻辑的案例。包括普通句子的翻译和集合的翻译。

### Negation in first-order logic

![[Negation in first-order logic.png|600]]
...
以及要灵活运用[[Propositional logic#^443af0|propositional logic]]中的一些equivalences
